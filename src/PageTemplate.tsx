  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        ></script>
        <section style="text-align: center; padding: 3rem 1rem; color: white;">
  <h1>EliteUSMD: Nationwide Medical Director & Compliance Solutions</h1>
  <h2>Your Partner in Medspa & Aesthetic Practice Success</h2>
